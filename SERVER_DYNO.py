...
def all_pass():
	...
	with ThreadPoolExecutor(max_workers=25) as g:
		for yuzong in ids:
			...
			pwv.append(psn+"123")
			pwv.append(psn+"1234")
			pwv.append(psn+"12345")
			pwv.append(psn+"123456") 
			pwv.append(psn+"1234567")
			pwv.append(psn+"12345678")  
			pwv.append(psn+"123456780")
			pwv.append(psn+psn)
			pwv.append(frs+lsn)
			pwv.append(psn+"1122")
			pwv.append(psn+"112233")
			pwv.append(psn+"0000")
			pwv.append(psn+"11")
			pwv.append(psn+"9000")
			pwv.append(psn+"1122")
